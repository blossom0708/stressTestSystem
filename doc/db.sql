...
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('2', 'MASTER_JMETER_HOME_KEY', '~/apache-jmeter-5.6.2', '1', '本地Jmeter_home绝对路径（Jmeter版本不要高于引擎版本；~表示用户目录）');
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('3', 'MASTER_JMETER_CASES_HOME_KEY', '~/apache-jmeter-5.6.2/stressTestCases', '1', '本地保存用例数据的绝对路径，不要随意切换会导致文件找不到错误。');
...
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('8', 'SCRIPT_SCHEDULER_DURATION_KEY', '14400', '1', '配置大于0:脚本限时执行生效，这里设置的是默认时间4小时；0或者不填:取消强制加入的脚本限时执行');
