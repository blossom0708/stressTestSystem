...
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('2', 'MASTER_JMETER_HOME_KEY', '~/.jmeter/apache-jmeter-5.1.1', '1', '本地Jmeter_home绝对路径（Jmeter版本不要高于引擎版本；~表示用户目录）');
