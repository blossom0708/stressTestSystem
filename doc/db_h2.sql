...
INSERT INTO sys_config (id, key, value, status, remark) VALUES ('2', 'MASTER_JMETER_HOME_KEY', '~/.jmeter/apache-jmeter-5.1.1', '1', '本地Jmeter_home绝对路径（Jmeter版本不要高于引擎版本）');
...
INSERT INTO sys_config (id, key, value, status, remark) VALUES ('7', 'SCRIPT_SCHEDULER_DURATION_KEY', '14400', '1', '配置大于0:脚本限时执行生效，这里设置的是默认时间1小时；0或者不填:取消强制加入的脚本限时执行');
